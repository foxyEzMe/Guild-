...
import { Loader2, Lock, User, Shield, Eye, EyeOff, Crown, Sparkles, Zap, Star, UserPlus } from "lucide-react";
        ...
        {particles.map((particle) => (
          <div
            ...
            style={{
              left: `${particle.x}%`,
              top: `${particle.y}%`,
              animation: `float ${3 + (particle.id % 4)}s ease-in-out infinite`,
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="text-center pt-6">
                    <p className="text-purple-300/80 text-sm mb-4">
                      Pas encore membre de l'élite ?
                    </p>
                    <Button
                      type="button"
                      variant="outline"
                      onClick={() => setLocation('/register')}
                      className="w-full border-2 border-neon-purple/50 hover:border-neon-magenta text-neon-purple hover:text-white hover:bg-gradient-to-r hover:from-neon-purple hover:to-neon-magenta transition-all duration-300 font-semibold py-3"
                    >
